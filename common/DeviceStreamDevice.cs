...
namespace AzIoTHubDeviceStreams
{
    ...
    public class DeviceStream_Device
    {
        ...
        public DeviceStream_Device(DeviceClient deviceClient, ActionReceivedTextIO _OnRecvdText, ActionReceivedText _OnDeviceStatusUpdateD = null, bool _keepDeviceListening = false, DeviceAndSvcCurrentSettings deviceCurrentSettings = null)
        {
        ...
        public static async Task RunDevice(string device_cs, ActionReceivedTextIO _OnRecvText, ActionReceivedText _OnDeviceStatusUpdateD = null, bool _keepDeviceListening = false, DeviceAndSvcCurrentSettings deviceCurrentSettings = null)
        {
            ...
            do
            {
                ...
                try
                {
                    using (DeviceClient deviceClient = DeviceClient.CreateFromConnectionString(device_cs, device_hubTransportTryp))
                    {
                        ...
                        deviceStream_Device = new DeviceStream_Device(deviceClient, _OnRecvText, _OnDeviceStatusUpdateD, _keepDeviceListening, deviceCurrentSettings);
                ...
                __keepDeviceListening = deviceStream_Device.KeepDeviceListening;
