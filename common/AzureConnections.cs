...
namespace AzureConnections
{
    public static class MyConnections
    {
        ...
        */
        public static string IoTHubConnectionString = "HostName=djausWithStreams.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=eFIz7j/Kw1nmtPuQl6Rw/duezdCJCEF2Q3tng7TMc0w=";
